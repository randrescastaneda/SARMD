...
** DIRECTORY
	...
	glo output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\BGD\BGD_2016_HIES\BGD_2016_HIES_v01_M_v02_A_SARMD"
...
** LOG FILE
	log using "${output}\Doc\Technical\BGD_2016_HIES_v01_M_v02_A_SARMD.log", replace
...
** KEEP VARIABLES - ALL
	...
	keep countrycode year survey int_year int_month idh idp wgt strata psu vermast veralt ///
...
** ORDER VARIABLES
	...
	order countrycode year survey int_year int_month idh idp wgt strata psu vermast veralt ///
	urban subnatid1	subnatid2 subnatid3 ownhouse tenure landholding water_original ///
	water_jmp water_source improved_water piped_water pipedwater_acc watertype_quest ///
	sanitation_original sewage_toilet toilet_jmp sanitation_source toilet_acc ///
	improved_sanitation electricity landphone cellphone computer internet hsize ///
...
** DELETE MISSING VARIABLES
	...
	saveold "${output}\Data\Harmonized\BGD_2016_HIES_v01_M_v02_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\BGD_2016_HIES_v01_M_v02_A_SARMD_IND.dta", replace version(12)
