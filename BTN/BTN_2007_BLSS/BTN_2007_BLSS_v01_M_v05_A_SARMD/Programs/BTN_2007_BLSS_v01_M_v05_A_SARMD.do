...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\BTN_2007_BLSS_v01_M_v05_A_SARMD-FULL_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\BTN_2007_BLSS_v01_M_v05_A_SARMD-FULL_IND.dta", replace version(12)
	notes
	log close
...
note _dta: "BTN 2007" Variables NAMED with "v2" are those not compatible with latest round (2012). ///
 These include the existing information from the particular survey, but the iformation should be used for comparability purposes  
	saveold "`output'\Data\Harmonized\BTN_2007_BLSS_v01_M_v05_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\BTN_2007_BLSS_v01_M_v05_A_SARMD_IND.dta", replace version(12)
