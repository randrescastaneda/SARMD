...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\MDV\MDV_2002_HIES\MDV_2002_HIES_v01_M_v04_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\MDV_2002_HIES_v01_M_v04_A_SARMD.log",replace
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year  ///
		...
		pipedwater_acc watertype_quest electricity toilet sanitation_original sanitation_source improved_sanitation toilet_acc ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\MDV_2002_HIES_v01_M_v04_A_SARMD-FULL_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\MDV_2002_HIES_v01_M_v04_A_SARMD-FULL_IND.dta", replace version(12)
...
saveold "`output'\Data\Harmonized\MDV_2002_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\MDV_2002_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
