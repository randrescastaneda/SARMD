...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\MDV\MDV_2009_HIES\MDV_2009_HIES_v01_M_v04_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\MDV_2009_HIES_v01_M_v04_A_SARMD.log",replace
...
*****************************************************************************************************/
	...
	* Consumption
	...
	sort hhid pid
	keep hhid pid pce pcer z* spi hhsize wght_hh  wght_ind 
	...
	**Add durables
	loc inp2 "ConsumerApp ConsumerAV ConsumerTC"
	loc j=0
	foreach i of local inp2{
	use "`input'\Data\Stata\\`i'.dta", clear
	gen des=upper(itemDesc)
	replace des=strtoname(des)
	replace numItemsOld=0  if itemOldYN=="2"
	duplicates drop formID des, force
	keep formID numItemsOld des
	ren numItemsOld numbit
	ren formID hhid
	drop if des=="KUDA_KUDHINNAH_FEN_HOONU_KURAA"
	...
	* Demographics
	...
	drop merge*
	notes _dta:"MDV 2009" The hh roster chosen for this round commes from file "wf2009.dta" that has welfare aggregates. There are some people not taken account for consumption meassures coming from demographics data-set "Demogr.dta"
	
	**Merge durables 
	foreach s in durable0 durable1 durable2 {
	merge m:1 hhid using ``s''
	drop _merge
	}
...
notes _dta: "MDV 2009" Variable strata comes from variable region. PSU is missing.
...
*<_urban_>
	...
	*recode urban (2=0)
	...
	notes urban: "MDV 2009" the urban area in this context is comprised by Male'. Rural areas are the rest of Atolls
*</_urban_>
...
*<_relationharm_>
	...
	notes relationharm: "MDV 2009" The coding for the variable relation to the household changed, with respect to the previous round
*</_relationharm_>
...
*<_educy_>
	...
	*Substract 1 year to those  curretly attending
	replace educy=educy-1 if   elevel1<13
	replace educy=1 if educy<0
	*Put 0 years of education to those whom never atteded
	replace educy=0 if  everattend==2
	*Put missing value to those with category 'other' and are still studying.
...
*<_educat7_>
	...
	*recode educat7 (18 19 = 7) (0 20 = 1) (1/4 = 2) (5=3) (6/11=4) (12=5) (14 16 17 =6) (13 15=7)
	recode educat7 (0=1) (1/4=2) (5=3) (6/11=4) (12=5) (14=6) (16=7) 
...
*<_ocusec_>
	*recode typeofjob (1 2 5 6 = 1) (3 4 7 0 =2) (8=.), gen(ocusec)
	...
	notes ocusec: "MDV 2009" The question for classification of type of establishment (public/private) is ambiguous on categories and was left as missing
*</_ocusec_>
...
*<_nlfreason_>
	...
	notes nlfreason: "MDV 2009" The categories in the questionnaires are not related to the harmonized options and the variables was created as missing
*</_nlfreason_>
...
*<_industry_orig_>
	...
	replace industry_orig="" if industry=="Q17" | industry=="Q18" | industry=="Q19"
...
*<_industry_>
	...
	recode industry (0/5=1) (10/14=2) (15/37=3) (40/41=4) (45=5) (50/55=6) (60/64=7) (65/74=8) (75=9) (80/99=10)
...
*<_occup_orig_>
	...
	replace occup_orig="" if occupation=="Q17" | occupation=="Q18" | occupation=="Q19"
...
*<_empstat_2_>
	gen byte empstat_2=Q15
	recode empstat_2 1=3 2=1 3=4 4=5 5=2
...
*<_industry_2_>
	...
	recode industry_2 (0=10) (1/5=1) (10/14=2) (15/37=3) (40/41=4) (45=5) (50/55=6) (60/64=7) (65/74=8) (75=9) (80/99=10)
...
*<_landphone_>
	...
	gen byte landphone= numbitTELEPHONE>0 if numbitTELEPHONE<.
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year  ///
		subnatid1 subnatid2 subnatid3 ownhouse landholding tenure water water_original water_source improved_water ///
		pipedwater_acc watertype_quest electricity toilet sanitation_original sanitation_source improved_sanitation toilet_acc landphone cellphone ///
	     computer internet hsize relationharm relationcs male age soc marital ed_mod_age everattend ///
	     atschool electricity literacy educy educat4 educat5 educat7 lb_mod_age lstatus lstatus_year empstat empstat_year njobs njobs_year ///
	     ocusec nlfreason unempldur_l unempldur_u industry_orig industry occup_orig occup firmsize_l firmsize_u whours wage ///
		  unitwage empstat_2 empstat_2_year industry_2 industry_orig_2 occup_2 wage_2 unitwage_2 contract healthins socialsec union rbirth_juris rbirth rprevious_juris rprevious yrmove ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\MDV_2009_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\MDV_2009_HIES_v01_M_v04_A_SARMD_IND.dta", replace version(12)
