...
** YEAR				2013
** SURVEY NAME		Nepal Annual Household Survey 2013-2014
...
** DIRECTORY
	local input "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\NPL\NPL_2013_AHS\NPL_2013_AHS_v01_M"
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\NPL\NPL_2013_AHS\NPL_2013_AHS_v01_M_v01_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\NPL_2013_AHS_v01_M_v01_A_SARMD.log",replace
...
* PREPARE DATASETS
	...
	use "`input'\Data\Stata\wt.dta", clear
	qui compress
	tempfile weights
	save `weights'		
	...
	use "`input'\Data\Stata\s03.dta", clear
	collapse (rawsum) home_val purchase_val received_val, by(psu hhno)
	qui compress
	tempfile food
	save `food'	
	
	use "`input'\Data\Stata\s04a.dta", clear
	collapse (rawsum) amount12, by(psu hhno)
	qui compress
	tempfile non_food
	save `non_food'
	
	use "`input'\Data\Stata\s04b.dta", clear
	qui compress
	tempfile production
	save `production'	
	
	use "`input'\Data\Stata\s04c.dta", clear
	...
	use "`input'\Data\Stata\s05.dta", clear
	qui compress
	tempfile labor
	save `labor'	
	...
	* MERGE DATASETS AT HOUSEHOLD LEVEL
	use `cover', clear
	merge 1:1 psu hhno using `weights'
	drop _merge
	merge 1:1 psu hhno using `housing'
	drop _merge
	merge 1:1 psu hhno using `durables'
	drop _merge
	merge 1:1 psu hhno using `food'
	drop _merge
	merge 1:1 psu hhno using `non_food'
	drop _merge
	qui compress
	tempfile households
	save `households'
	...
	* MERGE DATASETS AT INDIVIDUAL LEVEL
	use `roster', clear
	merge m:1 psu hhno using `households'
...
*<_ed_mod_age_>
	...
	note ed_mod_age: "NPL 2013" The minimum age of application for the education module is 5 years old
*</_ed_mod_age_>
...
*<_atschool_>
	...
	note atschool: "NPL 2013" Currently attending school 
*</_atschool_>
...
*<_literacy_>
	...
	note atschool: "NPL 2013" Can both read and write a letter
*</_literacy_>
...
*<_educy_>
	...
	notes educy: "NPL 2013" There is a substraction of 1 year in the computation of years of schooling for those currently attending
*</_educy_>
...
*<_landphone_>
	...
	note landphone: "NPL 2013" Variable is defined as hh having telephone
*</_landphone_>
...
*<_cellphone_>
	...
	note cellphone: "NPL 2013" Variable is defined as hh having mobile phone
*</_cellphone_>
...
*<_computer_>
	...
	note computer: "NPL 2013" Variable is defined as hh having computer/printer	
*</_computer_>
...
*<_radio_>
	...
	note computer: "NPL 2013" Variable is defined as hh having Radio/ tape/CD player/DVD Player	
*</_radio_>
...
*<_television_>
	...
	note television: "NPL 2013" Variable is defined as hh having T.V. 
*</_television>
...
*<_fan_>
	...
	note fan: "NPL 2013" Variable is defined as hh having electric fan
*</_fan>
...
*<_sewingmachine_>
	...
	note sewingmachine: "NPL 2013" Variable is defined as hh having sewing machine
*</_sewingmachine>
...
*<_washingmachine_>
	...
	note sewingmachine: "NPL 2013" Variable is defined as hh having washing machine
*</_washingmachine>
...
*<_refrigerator_>
	...
	note refrigerator: "NPL 2013" Variable is defined as hh having refrigerator
*</_refrigerator>
...
*<_bycicle_>
	...
	note bicycle: "NPL 2013" Variable is defined as hh having refrigerator
*</_bycicle>
...
*<_motorcycle_>
	...
	note motorcycle: "NPL 2013" Variable is defined as hh having motorcycle
*</_motorcycle>
...
*<_motorcar_>
	...
	note motorcar: "NPL 2013" Variable is defined as hh having motorcar
*</_motorcar>
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\NPL_2013_AHS_v01_M_v01_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\NPL_2013_AHS_v01_M_v01_A_SARMD_IND.dta", replace version(12)
	notes
