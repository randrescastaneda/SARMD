...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\PAK\PAK_2007_PSLM\PAK_2007_PSLM_v02_M_v02_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\PAK_2007_PSLM_v02_M_v02_A_SARMD.log",replace
/*****************************************************************************************************
*                                                                                                    *
                                   * ASSEMBLE DATABASE
*                                                                                                    *
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2007_PSLM_v02_M_v02_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2007_PSLM_v02_M_v02_A_SARMD_IND.dta", replace  version(13)
