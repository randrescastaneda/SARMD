...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\IND\IND_2011_NSS68-SCH1.0-T1\IND_2011_NSS68-SCH1.0-T1_v01_M_v04_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\IND_2011_NSS68-SCH1.0-T1_v01_M_v04_A_SARMD.log",replace
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt wgt_wdi strata psu vermast veralt urban int_month int_year fieldwork ///
		  ...
		  watertype_quest electricity toilet sanitation_original sanitation_source improved_sanitation toilet_acc internet ///
	      hsize relationharm relationcs male age soc marital ed_mod_age everattend ///
	      atschool electricity literacy educy educat4 educat5 educat7 lb_mod_age lstatus empstat njobs ///
	      ocusec nlfreason unempldur_l unempldur_u industry occup firmsize_l firmsize_u whours wage ///
		  unitwage contract healthins socialsec union lstatus_e empstat_e industry_e_orig industry_e  occup_e_orig occup_e  ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\IND_2011_NSS68-SCH1.0-T1_v01_M_v04_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\IND_2011_NSS68-SCH1.0-T1_v01_M_v04_A_SARMD_IND.dta", replace version(12)
