...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\AFG\AFG_2007_NRVA\AFG_2007_NRVA_v01_M_v05_A_SARMD"
	...
	** LOG FILE
log using "`output'\Doc\Technical\AFG_2007_NRVA_v01_M_v05_A_SARMD.log",replace
/*****************************************************************************************************
*                                                                                                    *
                                   * ASSEMBLE DATABASE
*                                                                                                    *
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork subnatid0 ///
		subnatid1 subnatid2 subnatid3 ownhouse landholding tenure water_orig piped_water water_jmp sar_improved_water water_original ///
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\AFG_2007_NRVA_v01_M_v05_A_SARMD-FULL_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\AFG_2007_NRVA_v01_M_v05_A_SARMD-FULL_IND.dta", replace version(12)
...
note _dta: "AFG 2007" Variables NAMED with "v2" are those not compatible with latest round (2013). ///
	...
	saveold "`output'\Data\Harmonized\AFG_2007_NRVA_v01_M_v05_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\AFG_2007_NRVA_v01_M_v05_A_SARMD_IND.dta", replace version(12)
