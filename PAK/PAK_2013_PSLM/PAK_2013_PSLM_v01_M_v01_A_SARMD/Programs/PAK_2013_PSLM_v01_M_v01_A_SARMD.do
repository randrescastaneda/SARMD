...
** DIRECTORY
	local input "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\PAK\PAK_2013_PSLM\PAK_2013_PSLM_v01_M"
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\PAK\PAK_2013_PSLM\PAK_2013_PSLM_v01_M_v01_A_SARMD"

** LOG FILE
	log using "`output'\Doc\PAK_2013_PSLM.log",replace
...
*/
	use "`input'\Data\Original\Consumption Master File.dta"
	tempfile comp
	keep if year==2013
	keep hhcode nomexpend eqadultM peaexpM psupind pline texpend region
	save  `comp' , replace
...
** MONTH
	gen month=mdy(month1,day1,year1)
	format month %td
...
** RELATIONSHIP TO THE HEAD OF HOUSEHOLD
	...
	replace hhsize=. if relationharm==6
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2013_PSLM_v01_M_v01_A_SARMD_IND.dta", replace version(13)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2013_PSLM_v01_M_v01_A_SARMD_IND.dta", replace version(13)
	...
	save "D:\__I2D2\Pakistan\2013\Processed\PAK_2013_I2D2_PSLM.dta", replace
	save "D:\__CURRENT\PAK_2013_I2D2_PSLM.dta", replace
	*/
	log close
