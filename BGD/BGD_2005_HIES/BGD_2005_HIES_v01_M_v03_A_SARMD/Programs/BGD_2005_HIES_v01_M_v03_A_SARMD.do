...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\BGD\BGD_2005_HIES\BGD_2005_HIES_v01_M_v03_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\BGD_2005_HIES_v01_M_v03_A_SARMD.log",replace
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\BGD_2005_HIES_v01_M_v03_A_SARMD-FULL_IND.dta", replace
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\BGD_2005_HIES_v01_M_v03_A_SARMD-FULL_IND.dta", replace
...
cap sum `i'
 ...
 These include the existing information from the particular survey, but the iformation should be used for comparability purposes  
	...
	saveold "`output'\Data\Harmonized\BGD_2005_HIES_v01_M_v03_A_SARMD_IND.dta", replace
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\BGD_2005_HIES_v01_M_v03_A_SARMD_IND.dta", replace
