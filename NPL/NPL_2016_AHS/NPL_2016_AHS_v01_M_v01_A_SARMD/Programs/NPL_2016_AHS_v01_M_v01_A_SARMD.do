...
** YEAR				2016
** SURVEY NAME		Nepal Annual Household Survey 2016-2017
...
** DIRECTORY
	local input "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\NPL\NPL_2016_AHS\NPL_2016_AHS_v01_M"
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\NPL\NPL_2016_AHS\NPL_2016_AHS_v01_M_v01_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\NPL_2016_AHS_v01_M_v01_A_SARMD.log",replace
...
** PREPARE DATASETS
	...
	use "`input'\Data\Stata\ahsweight7374.dta", clear
	qui compress
	tempfile weights
	save `weights'		
	...
	* MERGE DATASETS AT HOUSEHOLD LEVEL
	use `cover', clear
	merge 1:1 hhid using `weights'
	drop _merge
	merge 1:1 hhid using `housing'
	drop _merge
...
*<_ed_mod_age_>
	...
	note ed_mod_age: "NPL 2016" The minimum age of application for the education module is 5 years old
*</_ed_mod_age_>
...
*<_atschool_>
	...
	note atschool: "NPL 2016" Currently attending school 
*</_atschool_>
...
*<_literacy_>
	...
	note atschool: "NPL 2016" Can both read and write a letter
*</_literacy_>
...
*<_educy_>
	...
	notes educy: "NPL 2016" There is a substraction of 1 year in the computation of years of schooling for those currently attending
*</_educy_>
...
*<_landphone_>
	...
	note landphone: "NPL 2016" Variable is defined as hh having telephone
*</_landphone_>
...
*<_cellphone_>
	...
	note cellphone: "NPL 2016" Variable is defined as hh having mobile phone
*</_cellphone_>
...
*<_computer_>
	...
	note computer: "NPL 2016" Variable is defined as hh having computer/printer	
*</_computer_>
...
*<_radio_>
	...
	note computer: "NPL 2016" Variable is defined as hh having Radio/ tape/CD player/DVD Player	
*</_radio_>
...
*<_television_>
	...
	note television: "NPL 2016" Variable is defined as hh having T.V. 
*</_television>
...
*<_fan_>
	...
	note fan: "NPL 2016" Variable is defined as hh having electric fan
*</_fan>
...
*<_sewingmachine_>
	...
	note sewingmachine: "NPL 2016" Variable is defined as hh having sewing machine
*</_sewingmachine>
...
*<_washingmachine_>
	...
	note sewingmachine: "NPL 2016" Variable is defined as hh having washing machine
*</_washingmachine>
...
*<_refrigerator_>
	...
	note refrigerator: "NPL 2016" Variable is defined as hh having refrigerator
*</_refrigerator>
...
*<_bycicle_>
	...
	note bicycle: "NPL 2016" Variable is defined as hh having refrigerator
*</_bycicle>
...
*<_motorcycle_>
	...
	note motorcycle: "NPL 2016" Variable is defined as hh having motorcycle
*</_motorcycle>
...
*<_motorcar_>
	...
	note motorcar: "NPL 2016" Variable is defined as hh having motorcar
*</_motorcar>
...
** KEEP VARIABLES - ALL
	...
	keep countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork subnatid0  ///
		subnatid1 subnatid2 subnatid3 ownhouse  tenure water_orig piped_water water_jmp sar_improved_water  electricity toilet_orig sewage_toilet toilet_jmp sar_improved_toilet  cellphone ///
...
** ORDER VARIABLES
	...
	order countrycode year survey idh idp wgt pop_wgt strata psu vermast veralt urban int_month int_year fieldwork subnatid0 ///
		...
		sanitation_original sanitation_source improved_sanitation toilet_acc cellphone ///
	     computer internet hsize relationharm relationcs male age  marital ed_mod_age everattend ///
	     atschool electricity literacy educy educat4 educat5 educat7 ///
...
drop fieldwork improved_sanitation improved_water pipedwater_acc sanitation_original sanitation_source  tenure toilet_acc water_source watertype_quest
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\NPL_2016_AHS_v01_M_v01_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\NPL_2016_AHS_v01_M_v01_A_SARMD_IND.dta", replace version(12)
	notes
