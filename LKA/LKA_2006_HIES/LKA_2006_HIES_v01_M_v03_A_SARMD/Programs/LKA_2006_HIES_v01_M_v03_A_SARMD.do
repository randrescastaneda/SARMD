...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\LKA\LKA_2006_HIES\LKA_2006_HIES_v01_M_v03_A_SARMD\"
...
** LOG FILE
	log using "`output'\Doc\Technical\LKA_2006_HIES_v01_M_v03_A_SARMD.log",replace
...
*Landholding information
	use "`input'\Data\Stata\sec_9_land_animal.dta", clear
	gen double HID=district*1000000 + psu *1000 + sample_n*10 + serial_no
	sort HID
	tempfile landhold
	save `landhold'
...
notes _dta: "LKA 2006" Data analysis done only on people whom are living in the house.
...
*<_strata_>
	...
	note strata: "LKA 2006" Variable strata cannot be readily identified
*</_strata_>
...
*<_sector_>
	...
	notes _dta: "LKA 2006" Variable "sector" not included in the dictionaries and left as missing.
*</_sector_>
...
*<_ownhouse_>
	...
	notes ownhouse: "LKA 2006" variable tenure=1 if hh constructed/purchased;inherited;freely recieved; was compensated. 0=otherwise 
*</_ownhouse_>
...
*<_tenure_>
   gen tenure=.
   replace tenure=1 if ownership<=4
   replace tenure=2 if ownership==5 | ownership==6
...
note water_jmp: "LKA 2006" Category "Stream water collected & distributed by pipe lines" is ///
...
*<_electricity_>
	...
	notes electricity: "LKA 2006" variable was created if household's main source of lighting is electricity
*</_electricity_>
...
note sewage_toilet: "LKA 2006" There is not certainty if water seal/pour flush are sanitation sources connected to sewage system
...
*</_toilet_jmp_>
note toilet_jmp: "LKA 2006" Due to multiple ambiguities, toilet_jmp could not be identified.
...
*<_hsize_>
	...
	notes hsize: "LKA 2006" all individuals normally living in the household  were taken into account for the measurement of household size, according to questionnaire
*</_hsize_>
...
* Generate Age based on Month and Year of Birth for missing cases
	...
	notes age: "LKA 2006" Variable was generated based on the month and year of birth for missing cases
*</_age_>
...
*<_atschool_>
	...
	notes atschool: "LKA 2006" attendace variable was used (people 5=>)
*</_atschool_>
...
*<_literacy_>
	...
	notes literacy: "LKA 2006" no question that relates literacy for this round
*</_literacy_>
...
*<_everattend_>
	recode  curr_education (1/6=1) (7=.) , gen(everattend)
	replace everattend=0 if r2_school_education==2
	replace everattend=1 if atschool==1 | r2_school_education==3 | atschool==1
...
*<_industry_>
	...
	notes industry: "LKA 2006" ISIC Rev.3 is used.
*</_industry_>
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\LKA_2006_HIES_v01_M_v03_A_SARMD-FULL_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\LKA_2006_HIES_v01_M_v03_A_SARMD-FULL_IND.dta", replace version(12)
...
note _dta: "LKA 2006" Variables NAMED with "v2" are those not compatible with latest round (2012). ///
...
saveold "`output'\Data\Harmonized\LKA_2006_HIES_v01_M_v03_A_SARMD_IND.dta", replace version(12)
saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\LKA_2006_HIES_v01_M_v03_A_SARMD_IND.dta", replace version(12)
