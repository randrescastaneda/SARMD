...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\PAK\PAK_2013_PSLM\PAK_2013_PSLM_v01_M_v03_A_SARMD"

** LOG FILE
	log using "`output'\Doc\Technical\PAK_2013_PSLM_v01_M_v03_A_SARMD.log",replace
...
** EDUCATIONAL LEVEL 1
	...
	gen byte edulevel1=1 if educy==0
	replace edulevel1=2 if educy >0 & educy<8
	replace edulevel1=3 if educy==8
	replace edulevel1=4 if educy>8 &  educy<12
	replace edulevel1=5 if educy==12
	replace edulevel1=6 if educy>12 & educy<=19
	replace edulevel1=2 if s2bq14==1
	replace edulevel1=. if educy==.
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2013_PSLM_v01_M_v03_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2013_PSLM_v01_M_v03_A_SARMD_IND.dta", replace version(13)
