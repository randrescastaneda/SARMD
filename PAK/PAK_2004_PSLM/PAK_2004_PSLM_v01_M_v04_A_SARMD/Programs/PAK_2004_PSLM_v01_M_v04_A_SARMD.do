...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\PAK\PAK_2004_PSLM\PAK_2004_PSLM_v01_M_v04_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\PAK_2004_PSLM_v01_M_v04_A.log",replace
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2004_PSLM_v01_M_v04_A_SARMD-FULL_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2004_PSLM_v01_M_v04_A_SARMD-FULL_IND.dta", replace version(13)
	log close
...
cap sum `i'
 ...
 These include the existing information from the particular survey, but the iformation should be used for comparability purposes  
	saveold "`output'\Data\Harmonized\PAK_2004_PSLM_v01_M_v04_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2004_PSLM_v01_M_v04_A_SARMD_IND.dta", replace version(13)
