...
** YEAR				2014
** SURVEY NAME		Nepal Annual Household Survey 2014-2015
...
** DIRECTORY
	local input "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\NPL\NPL_2014_AHS\NPL_2014_AHS_v01_M"
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\NPL\NPL_2014_AHS\NPL_2014_AHS_v01_M_v01_A_SARMD"
...
** LOG FILE
	log using "`output'\Doc\Technical\NPL_2014_AHS_v01_M_v01_A_SARMD.log",replace
...
* PREPARE DATASETS
	...
	use "`input'\Data\Stata\ahsweight.dta", clear
	qui compress
	tempfile weights
	save `weights'		
	...
	collapse (rawsum) home_val purchase_val received_val, by(hhid)
	qui compress
	tempfile food
	save `food'	
	
	use "`input'\Data\Stata\S04a_rc.dta", clear
	collapse (rawsum) amount12, by(hhid)
	qui compress
	tempfile non_food
	save `non_food'
	...
	sum yesno* durable_num* received* yearsago* purchase_price* current_value*, sep(19)
	qui compress
	tempfile durables
	save `durables'	
	
	use "`input'\Data\Stata\roster_labour.dta", clear
	use "`input'\Data\Stata\S05_rc.dta", clear
	qui compress
	tempfile labor
	save `labor'	
	...
	* MERGE DATASETS AT HOUSEHOLD LEVEL
	...
	drop _merge
	merge 1:1 psu hhno using `durables'
	drop _merge
...
*<_ed_mod_age_>
	...
	note ed_mod_age: "NPL 2014" The minimum age of application for the education module is 5 years old
*</_ed_mod_age_>
...
*<_atschool_>
	...
	note atschool: "NPL 2014" Currently attending school 
*</_atschool_>
...
*<_literacy_>
	...
	note atschool: "NPL 2014" Can both read and write a letter
*</_literacy_>
...
*<_educy_>
	...
	notes educy: "NPL 2014" There is a substraction of 1 year in the computation of years of schooling for those currently attending
*</_educy_>
...
*<_landphone_>
	...
	note landphone: "NPL 2014" Variable is defined as hh having telephone
*</_landphone_>
...
*<_cellphone_>
	...
	note cellphone: "NPL 2014" Variable is defined as hh having mobile phone
*</_cellphone_>

** COMPUTER
*<_computer_>
	gen byte computer=yesnoComputer_Printe
	replace computer=2 if computer==.
	recode computer (2=0)(1=1)
	label var computer "Household has computer"
	la de lblcomputer 0 "No" 1 "Yes"
	label values computer lblcomputer
	note computer: "NPL 2014" Variable is defined as hh having computer/printer	
*</_computer_>

** RADIO
*<_radio_>
	gen byte radio=yesnoRadio_tape_CD_o
	replace radio=2 if radio==.
	recode radio (2=0)(1=1)
	label var radio "Household has radio"
	la de lblradio 0 "No" 1 "Yes"
	label val radio lblradio
	note computer: "NPL 2014" Variable is defined as hh having Radio/ tape/CD player/DVD Player	
*</_radio_>

** TELEVISION
*<_television_>
	gen byte television=yesnoTelevision
	replace television=2 if television==.
	...
	note television: "NPL 2014" Variable is defined as hh having T.V. 
*</_television>

** FAN
*<_fan_>
	gen byte fan=yesnoElectric_fan
	replace fan=2 if fan==.
	recode fan (2=0)(1=1)
	label var fan "Household has Fan"
	la de lblfan 0 "No" 1 "Yes"
	label val fan lblfan
	note fan: "NPL 2014" Variable is defined as hh having electric fan
*</_fan>

** SEWING MACHINE
*<_sewingmachine_>
	gen byte sewingmachine=yesnoTailoring_machi
	replace sewingmachine=2 if sewingmachine==.
	...
	note sewingmachine: "NPL 2014" Variable is defined as hh having sewing machine
*</_sewingmachine>

** WASHING MACHINE
*<_washingmachine_>
	gen byte washingmachine=yesnoWashing_machine
	replace washingmachine=2 if washingmachine==.
	...
	note sewingmachine: "NPL 2014" Variable is defined as hh having washing machine
*</_washingmachine>

** REFRIGERATOR
*<_refrigerator_>
	gen byte refrigerator=yesnoRefrigerator
	replace refrigerator=2 if refrigerator==.
	...
	note refrigerator: "NPL 2014" Variable is defined as hh having refrigerator
*</_refrigerator>
...
*<_motorcycle_>
	...
	note motorcycle: "NPL 2014" Variable is defined as hh having motorcycle
*</_motorcycle>

** MOTOR CAR
*<_motorcar_>
	gen byte motorcar=yesnoMotorcar
	replace motorcar=2 if motorcar==.
	...
	note motorcar: "NPL 2014" Variable is defined as hh having motorcar
*</_motorcar>
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\NPL_2014_AHS_v01_M_v01_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\NPL_2014_AHS_v01_M_v01_A_SARMD_IND.dta", replace version(12)
	notes
