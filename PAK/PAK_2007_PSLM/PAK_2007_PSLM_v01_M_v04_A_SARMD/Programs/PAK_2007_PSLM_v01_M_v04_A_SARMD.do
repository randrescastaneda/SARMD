...
** DIRECTORY
	...
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\PAK\PAK_2007_PSLM\PAK_2007_PSLM_v01_M_v04_A_SARMD"
	glo pricedata "D:\SOUTH ASIA MICRO DATABASE\CPI\cpi_ppp_sarmd_weighted.dta"

** LOG FILE
	log using "`output'\Doc\Technical\PAK_2007_PSLM_v01_M_v04_A_SARMD.log",replace
...
note _dta: not possible to idetify landholding from existing raw files
note _dta: not possible to identify livestock ownership from existing raw files

**Add durables
	use "`input'\Data\Stata\psm4-07A.dta", clear
	...
	keep hhcode sno a0702
	decode sno, gen(itc)
	egen itc2=concat( itc sno )
	keep itc2 hhcode a0702
	ren a0702 numdur
...
*<_electricity_>
	...
	notes electricity: this variable is generated if hh has electrical connection or extension.
*</_electricity_>
...
** COMPUTER
*<_computer_>
	gen byte computer=numdurPersonal_Computer722>0 & numdurPersonal_Computer722<.
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\PAK_2007_PSLM_v01_M_v04_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\PAK_2007_PSLM_v01_M_v04_A_SARMD_IND.dta", replace  version(13)
