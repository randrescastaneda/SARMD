...
** DIRECTORY
	local input "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\IND\IND_2009_NSS-SCH1\IND_2009_NSS-SCH1_v01_M"
	local output "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\IND\IND_2009_NSS-SCH1\IND_2009_NSS-SCH1_v01_M_v02_A_SARMD"

** LOG FILE
	log using "`output'\Doc\Technical\IND_2009_NSS-SCH1_v01_M_v02_A_SARMD.log",replace
...
*<_everattend_>
	recode S1B4_v07 (1 2 3 4 = 0) (5 6 7 8 9 10 11 12 13=1), gen (everattend)
...
** LABOR STATUS
*<_lstatus_e_>
	gen lstatus_e=1 if S1B3_v04!=.
	replace lstatus_e=2 if S1B3_v03=="X00" /* Looking for Employment*/
...
** DELETE MISSING VARIABLES
	...
	saveold "`output'\Data\Harmonized\IND_2009_NSS-SCH1_v01_M_v02_A_SARMD_IND.dta", replace version(12)
	saveold "D:\SOUTH ASIA MICRO DATABASE\SAR_DATABANK\__REGIONAL\Individual Files\IND_2009_NSS-SCH1_v01_M_v02_A_SARMD_IND.dta", replace version(12)
